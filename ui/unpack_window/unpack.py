...
from archive_methods import decompression as decompression
...
class UnPackWindow:
    def __init__(self, archive_path):
        ...
        self.window.setObjectName("UW")
        self.window.setWindowIcon(QtGui.QIcon('icons/main.png'))
        self.window.setWindowTitle('Распаковать архив')
        ...
        self.dir_text.setText('Распаковать архив в:')
        ...
        self.ok_button.clicked.connect(self.start_decompressing)
    ...
    def start_decompressing(self):
        if self.check_validity():
            self.main_layout.itemAt(1).widget().setVisible(True)
            decompression.extract_all(self.path, str(self.dir_input.toPlainText()))
